...
from forms import RegistrationForm, LoginForm, IncomeForm, ExpenseForm, GoalForm, SavingsUpdateForm
...
class AdminModelView(ModelView):
    def is_accessible(self):
        return current_user.is_authenticated and current_user.username == 'admin'  # Change to your admin username
...
expense_categories = {
    "Housing": {
        "subcategories": [
            ...
            "Home Repairs", "Furniture", "Home Decor", "Security System",
            "Cleaning Services", "Home Insurance"
        ],
        "classification": {
            "Rent": "need", "Mortgage": "need", "Property Tax": "need",
            "Home Maintenance": "need", "Home Repairs": "need",
            "Furniture": "want", "Home Decor": "want",
            "Security System": "need", "Cleaning Services": "want",
            "Home Insurance": "need"
        }
    },
    "Food & Groceries": {
        "subcategories": [
            "Groceries", "Basic Food Staples", "Dining Out", "Fast Food",
            "Coffee Shops", "Food Delivery", "Snacks", "Meal Kits",
            "Specialty Foods"
        ],
        "classification": {
            "Groceries": "need", "Basic Food Staples": "need",
            "Dining Out": "want", "Fast Food": "want",
            "Coffee Shops": "want", "Food Delivery": "want",
            "Snacks": "want", "Meal Kits": "want",     
            "Specialty Foods": "want"
        }
    },
    "Transportation": {
        "subcategories": [
            "Fuel", "Public Transport", "Taxi/Rideshare",
            "Vehicle Maintenance", "Vehicle Insurance", "Parking Fees",
            "Tolls", "Car Loan Payment", "Car Wash", "Vehicle Registration"
        ],
        "classification": {
            "Fuel": "need", "Public Transport": "need",
            "Taxi/Rideshare": "want", "Vehicle Maintenance": "need",
            "Vehicle Insurance": "need", "Parking Fees": "need",
            "Tolls": "need", "Car Loan Payment": "need",
            "Car Wash": "want", "Vehicle Registration": "need"
        }
    },
    "Utilities": {
        "subcategories": [
            "Electricity", "Water", "Gas", "Internet",
            "Mobile Phone", "Trash Collection", "Sewer Charges",
            "Streaming Bundled with Internet"
        ],
        "classification": {
            "Electricity": "need", "Water": "need", "Gas": "need",
            "Internet": "need", "Mobile Phone": "need",
            "Trash Collection": "need", "Sewer Charges": "need",
            "Streaming Bundled with Internet": "want"
        }
    },
    "Healthcare": {
        "subcategories": [
            "Doctor Visits", "Hospital Bills", "Pharmacy",
            "Health Insurance", "Dental Care", "Vision Care",
            "Mental Health Therapy", "Medical Equipment", "Health Supplements"
        ],
        "classification": {
            "Doctor Visits": "need", "Hospital Bills": "need",
            "Pharmacy": "need", "Health Insurance": "need",
            "Dental Care": "need", "Vision Care": "need",
            "Mental Health Therapy": "need", "Medical Equipment": "need",
            "Health Supplements": "want"
        }
    },
    "Education": {
        "subcategories": [
            "School Tuition", "College Tuition", "Online Courses",
            "Books", "School Supplies", "Professional Certifications",
            "Workshops", "Educational Software"
        ],
        "classification": {
            "School Tuition": "need", "College Tuition": "need",
            "Online Courses": "want", "Books": "need",
            "School Supplies": "need", "Professional Certifications": "need",
            "Workshops": "want", "Educational Software": "need"
        }
    },
    "Insurance": {
        "subcategories": [
            "Health Insurance", "Life Insurance", "Vehicle Insurance",
            "Home Insurance", "Travel Insurance", "Pet Insurance"
        ],
        "classification": {
            "Health Insurance": "need", "Life Insurance": "need",
            "Vehicle Insurance": "need", "Home Insurance": "need",
            "Travel Insurance": "want", "Pet Insurance": "want"
        }
    },
    "Personal & Lifestyle": {
        "subcategories": [
            "Clothing", "Shoes", "Haircuts", "Beauty Products",
            "Gym Membership", "Salon Services", "Spa", "Personal Care Items"
        ],
        "classification": {
            "Clothing": "need", "Shoes": "need", "Haircuts": "need",
            "Beauty Products": "want", "Gym Membership": "want",
            "Salon Services": "want", "Spa": "want",
            "Personal Care Items": "need"
        }
    },
    "Entertainment": {
        "subcategories": [
            "Movies", "Concerts", "Gaming", "Streaming Subscriptions",
            "Hobbies", "Books & Magazines", "Theme Parks", "Events & Shows"
        ],
        "classification": {
            "Movies": "want", "Concerts": "want", "Gaming": "want",
            "Streaming Subscriptions": "want", "Hobbies": "want",
            "Books & Magazines": "want", "Theme Parks": "want",
            "Events & Shows": "want"
        }
    },
    "Travel": {
        "subcategories": [
            "Flights", "Hotels", "Vacation Packages", "Local Travel",
            "Travel Insurance", "Tour Guides", "Resort Stay"
        ],
        "classification": {
            "Flights": "want", "Hotels": "want", "Vacation Packages": "want",
            "Local Travel": "need", "Travel Insurance": "want",
            "Tour Guides": "want", "Resort Stay": "want"
        }
    },
    "Debt & Financial Obligations": {
        "subcategories": [
            "Credit Card Payment", "Loan Repayment", "Student Loan Payment",
            "Personal Loan", "Bank Fees", "Late Fees"
        ],
        "classification": {
            "Credit Card Payment": "need", "Loan Repayment": "need",
            "Student Loan Payment": "need", "Personal Loan": "need",
            "Bank Fees": "need", "Late Fees": "want"
        }
    },
    "Other": {
        "subcategories": ["Other (User Input)"],
        "classification": {
            "Other (User Input)": "unknown"
        }
    }
}
...
for main_cat, data in expense_categories.items():
    for subcat, classification in data["classification"].items():
...
def get_spending_suggestions(user_id, goal):
    ...
    for category, amount in sorted(category_totals.items(), key=lambda x: x[1], reverse=True)[:5]:
        ...
        months_saved = goal.remaining_amount / (goal.monthly_savings + reduction) if goal.monthly_savings > 0 else float('inf')
...
def dashboard():
    ...
    # Expenses this month
    expenses = Expense.query.filter(Expense.user_id==current_user.id, Expense.date>=month_start).all()
    ...
    # Income this month
    incomes = Income.query.filter(Income.user_id==current_user.id, Income.date_received>=month_start).all()
    total_income = sum(i.amount for i in incomes)
    source_breakdown = {}
    for inc in incomes:
        source_breakdown[inc.source] = source_breakdown.get(inc.source, 0) + inc.amount
    source_percentages = {src: (amt/total_income*100) if total_income else 0 for src, amt in source_breakdown.items()}
    
    # Recent incomes
    recent_incomes = Income.query.filter_by(user_id=current_user.id).order_by(Income.date_received.desc()).limit(10).all()
    # Recent expenses
...
def add_expense():
    ...
    if request.method == 'POST' and form.main_category.data:
        ...
        if main_cat in expense_categories:
            ...
            form.sub_category.choices = [('', '-- Select Sub Category --')] + [(sub, sub) for sub in subcats]
...
def subscriptions():
    ...
    return render_template('subscriptions.html', subscriptions=subs, total_cost=total_cost)
